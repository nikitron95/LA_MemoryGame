...
function disableCards() {
  ...
  if (matchedCards === totalPairs) {
    setTimeout(() => {
        showWinMessage();
    }, 1000); // Wartet 1 Sekunde, bevor die Gewinnnachricht angezeigt wird
}
...
function showWinMessage() {
    ...
    winMessage.className = "win-message"; // Stellen Sie sicher, dass Sie CSS für .win-message definieren
